...
<body>
  <div class="container">
    ...
    <form class="well form-horizontal" action="list.php" method="post"  id="contact_form">
<fieldset>
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Company list</label>
    <div class="col-md-4 selectContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select  required class="form-control selectpicker" name="CompanyName"  >
<?php 
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Name</label>
    ...
    <div class="input-group">
      ...
      <input required name="Name"  pattern="[^0-9]+" title="No number here !"  placeholder="Name" class="form-control" type="text" >
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Postion</label>
    <div class="col-md-4 selectContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select required  name="Postion" class="form-control selectpicker"  >
      <option> </option>
...
">other
    ...
    <div class="form-group">
  <label class="col-md-4 control-label">Phone 01</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
  <input required name="Phone1" placeholder="Phone 01" class="form-control"  type="text"  pattern="\d*" maxlength="9" minlength="7"  >
    </div>
  </div>
</div>
    ...
    <div class="form-group">
  <label class="col-md-4 control-label">Phone 02</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
  <input  name="Phone2" placeholder="Phone 02" class="form-control"  type="text"  pattern="\d*" maxlength="9" minlength="7" id="En_Name" >
    </div>
  </div>
</div>
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Mobile 01</label>
    <div class="col-md-4 selectContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
      <input  name="Mobile1" placeholder="Mobile 01" class="form-control" type="text"  pattern="\d*" maxlength="11" minlength="11" id="En_Name" >
  </div>
</div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">Mobile 02</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="Mobile2" placeholder="Mobile 02" class="form-control" type="text"  pattern="\d*" maxlength="11" minlength="11"  >
    </div>
  </div>
</div>
...
<!-- Text input-->
      <div class="form-group">
  <label class="col-md-4 control-label">Email_01</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="Email1" placeholder="email" class="form-control" type="email"  autofocus="autofocus" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
    </div>
  </div>
</div>
    ...
    <div class="form-group">
  <label class="col-md-4 control-label">Email_02</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="Email2" placeholder="email" class="form-control" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"> 
    </div>
  </div>
</div>
...
<!--<div class="form-group">
  ...
  <input name="city" placeholder="city" class="form-control"  type="text">
    ...
    <div class="form-group">
  <label class="col-md-4 control-label">Email_03</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="Email3" placeholder="email" class="form-control" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
    </div>
  </div>
</div>
...
$sql="insert into  list (companylist1,Name,Postion,Phone1,Phone2,Mobile1,Mobile2,Email1,Email2,Email3,Reg_Name,date) values('$CompanyName','$Name','$Postion','$Phone1','$Phone2','$Mobile1','$Mobile2','$Email1','$Email2','$Email3','$seg','$date')";
