...
s_a[63] = "Azuay|Bolivar|Canar|Carchi|Chimborazo|Cotopaxi|El Oro|Esmeraldas|Galapagos|Guayas|Imbabura|Loja|Los Rios|Manabi|Morona-Santiago|Napo|Orellana|Pastaza|Pichincha|Sucumbios|Tungurahua|Zamora-Chinchipe";
      ...
      s_a[64] = "Badakhshan|Badghis|Baghlan|Balkh|Bamian|Farah|Faryab|Ghazni|Ghowr|Helmand|Herat|Jowzjan|Kabol|Kandahar|Kapisa|Konar|Kondoz|Laghman|Lowgar|Nangarhar|Nimruz|Oruzgan|Paktia|Paktika|Parvan|Samangan|Sar-e Pol|Takhar|Vardak|Zabol";
...
<body>
  <div class="container">
    ...
    <form class="well form-horizontal" action="companylist.php" method="post"  id="contact_form">
<fieldset>
...
<!-- Text input-->
  ...
  <label class="col-md-4 control-label">Company Name *</label>
    ...
    <div class="input-group">
     ...
     <input required name="CompanyName"  pattern="[^0-9]+" title="No number here !"  placeholder="CompanyName" class="form-control" type="text" >
  </div>
</div>
</div>
    ...
    <div class="form-group"> 
  <label class="col-md-4 control-label">Ar_Name *</label>
    <div class="col-md-4 selectContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
     <input required name="Ar_Name"   placeholder="Ar_Name" class="form-control" type="text" >
  </div>
</div>
</div>  
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Type *</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select required  class="form-control selectpicker" name="Type"  >
              <option> </option>
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Brand *</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select required  class="form-control selectpicker" name="Brand" >
      <option> </option>
      <option>Maptec</option>
      <option>Estasmer</option>
...
<div class="form-group"> 
  <label class="col-md-4 control-label">Dep *</label>
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select required  name="Dep" class="form-control selectpicker"  >
      <option> </option>
    ...
    <div class="form-group"> 
  <label class="col-md-4 control-label">Field_of_Work *</label>
    <div class="col-md-4 selectContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select required name="Field_of_Work" class="form-control selectpicker"  >
      <option>  </option>
      <option value="ادارة المشروعات" >  ادارة المشروعات   </option>
        <option value="الاستثمار العقاري " > الاستثمار العقاري   </option>
        <option value="الاستشارات الهندسية " >  الاستشارات الهندسية  </option>
        <option value="الاسكان والتعمير " > الاسكان والتعمير  </option>
        <option value=" الانشاءات" >  الانشاءات  </option>
        <option value=" البناء والتشييد" >  البناء والتشييد  </option>
        <option value=" التصميمات الهندسية" >   التصميمات الهندسية </option>
        <option value="التكنولوجيا المتقدمة " >  التكنولوجيا المتقدمة  </option>
        <option value="التطوير العمراني " >  التطوير العمراني  </option>
        <option value="الخدمات العقارية " >  الخدمات العقارية  </option>
        <option value=" الخدمات والتقنيه" >  الخدمات والتقنيه  </option>
        <option value="المساحة " >  المساحة  </option>
        <option value=" المشروعات الهندسية" >  المشروعات الهندسية  </option>
          <option value=" المقاولات العامة" > المقاولات العامة   </option>
        
          <option value="التجارة " > التجارة   </option>
        
          <option value=" للاوصول العقارية والسياحيه" >  للاوصول العقارية والسياحيه  </option>
        
          <option value="للتوكيلات والاستشارات " > للتوكيلات والاستشارات   </option>
  ...
  <label class="col-md-4 control-label">Country *</label>  
     <div class="col-md-4 selectContainer">
    <div class="input-group">
        <select required id="country" name="Country"  class="form-control selectpicker"  ></select>
        <br />
          <br/>  <br/>
  ...
  <label class="col-md-2 control-label">city:*</label>  
    ...
    <div class="input-group">
       <select required name="City" id="state" class="form-control selectpicker"></select>
...
<div class="form-group">
  ...
  <input name="Phone1" required  class="form-control" type="text"  pattern="\d*" maxlength="9" minlength="7"  >
    </div>
  </div>
</div>
...
<!-- Text input-->
  ...
  <label class="col-md-4 control-label">Phone 2</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="Phone2"   placeholder="(845)555-1212" class="form-control" type="text"  pattern="\d*" maxlength="9" minlength="7" >
    </div>
  </div>
</div>
    ...
    <div class="form-group">
  <label class="col-md-4 control-label">Phone 3</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="Phone3" placeholder="(845)555-1212" class="form-control" type="text"  pattern="\d*" maxlength="9" minlength="7">
    </div>
  </div>
</div>
...
<!--<div class="form-group">
  ...
  <input name="city" placeholder="city" class="form-control"  type="text">
    ...
    <div class="form-group">
  <label class="col-md-4 control-label">fax 1</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="fax1" placeholder="(845)555-1212" class="form-control" type="text"  pattern="\d*" maxlength="9" minlength="7">
    </div>
  </div>
</div>

    <div class="form-group">
  <label class="col-md-4 control-label">fax 2</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="fax2" placeholder="(845)555-1212" class="form-control" type="text"  pattern="\d*" maxlength="9" minlength="7">
    </div>
  </div>
</div>
    
    <div class="form-group">
  <label class="col-md-4 control-label">fax 3</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="fax3" placeholder="(845)555-1212" class="form-control" type="text"  pattern="\d*" maxlength="9" minlength="7">
    </div>
  </div>
</div>
        ...
        <div class="form-group">
  <label class="col-md-4 control-label">mobile 1</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="mobile1" placeholder="(845)555-1212" class="form-control" type="text"  pattern="\d*" maxlength="11" minlength="11">
    </div>
  </div>
</div>
            <div class="form-group">
  <label class="col-md-4 control-label">mobile 2</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="mobile2" placeholder="(845)555-1212" class="form-control" type="text"  pattern="\d*" maxlength="11" minlength="11">
    </div>
  </div>
</div>
            <div class="form-group">
  <label class="col-md-4 control-label">mobile 3</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-earphone"></i></span>
  <input name="mobile3" placeholder="(845)555-1212" class="form-control" type="text"  pattern="\d*" maxlength="11" minlength="11">
    </div>
  </div>
</div>
  ...
  <input name="EMail1" required placeholder="E-Mail Address" class="form-control"  type="email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
    </div>
  </div>
</div>
 <div class="form-group">
  <label class="col-md-4 control-label">E-Mail 2</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
  <input name="EMail2" placeholder="E-Mail Address" class="form-control"  type="email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
    </div>
  </div>
</div>

  <div class="form-group">
  <label class="col-md-4 control-label">E-Mail 3</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
  <input name="EMail3" placeholder="E-Mail Address" class="form-control"  type="email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
    </div>
  </div>
</div>
    ...
    <div class="form-group">
  <label class="col-md-4 control-label">old URL</label>  
   <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
  <input name="oldURL" placeholder="Website or domain name" class="form-control" type="url">
    </div>
  </div>
</div>
  ...
  <label class="col-md-4 control-label"> Url</label>  
   <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-globe"></i></span>
  <input name="Url" placeholder="Website or domain name" class="form-control" type="url">
    </div>
  </div>
</div>
...
<!-- Select Basic -->
    ...
    <div class="form-group"> 
  <label class="col-md-4 control-label">Branchs</label>
    <div class="col-md-4 selectContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
    <select name="Branchs" required class="form-control selectpicker" >
      <option value=" " ></option>
   ...
   <div class="form-group">
  <label class="col-md-4 control-label">Bra_Address</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
  <input name="Bra" placeholder="Bra_Address" class="form-control" type="text">
    </div>
  </div>
</div> 
...
<div class="form-group">
 ...
 <!-- <select name=" " class="form-control selectpicker" >
  ...
  <label class="col-md-4 control-label">Refrence</label>  
    ...
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
  <input name="Refrence" placeholder="Refrence" class="form-control" type="text">
    </div>
  </div>
</div>
...
$sql="insert into  company (CompanyName,Type,Brand,Dep,Field_of_Work,Phone1,Phone2,Phone3,fax1,fax2,fax3,mobile1,mobile2,mobile3,EMail1,EMail2,EMail3,oldURL,Url,Address,Branchs,City,Refrence,Notes,date,seg,Country,Bra,Ar_Name) values('$CompanyName','$Typ','$Brand','$Dep','$Field_of_Work','$Phone1','$Phone2','$Phone3','$fax1','$fax2','$fax3','$mobile1','$mobile2','$mobile3','$EMail1','$EMail2','$EMail3','$oldURL','$Url','$Address','$Branchs','$City','$Refrence','$Notes','$date','$seg','$Country','$Bra','$Ar_Name')";
