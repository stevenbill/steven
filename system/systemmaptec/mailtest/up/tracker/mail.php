...
$message .= "Content-Type: text/html; charset=\"iso-8859-1\"\r\n"
  ...
  ."<img src='http://estasmer.com/mailtest/up/tracker/$boos' alt='image not found' />\r\n"
...
$fileba=explode(";",$ba);
   ...
   $sqlbad="insert into  email2 (Date,email,attach5,boos,times) values('$date','$ahmed','$attach5','$boos','$times')";
