...
$sql2="INSERT INTO `CustomerCalls`(Note,CallType ,KnownFrom,Receivedby,PhoneNumber,En_Fname,En_Lname,Ar_Fname,Ar_Lname,Date,Reg_By,Honorific) VALUES ('$Note','$CallType','$KnownFrom','$Receivedby','$PhoneNumber','$En_Fname','$En_Lname','$Ar_Fname','$Ar_Lname','$date','$seg','$Honorific')";
	...
	echo "welcom ". $seg= $_SESSION['logindata']         ?></a>
                   ...
                   <!-- <li class="xn-title">Components</li>                    
                    ...
                    <li class="xn-openable active">
                        ...
                        <ul>
                            <li class="active">
                                <a href="form-layouts-two-column.html"><span class="fa fa-tasks"></span> Form </a>
                                <div class="informer informer-danger">New</div>
                                <ul>
                                    <li class="active"><a href="form-layouts-one-column.php"><span class="fa fa-align-justify"></span> New Client</a></li>
                                 <!--   <li><a href="form-layouts-two-column.html"><span class="fa fa-th-large"></span> Two Column</a></li>-->
                                    <li><a href="Customer_Calls.php"><span class="fa fa-table"></span> Customer Calls</a></li>
...
<div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" list="categoryname"  class="form-control" autocomplete="off" id="pcategory"  required="required" name="PhoneNumber" />
    ...
    <?php mysqli_close($connection); ?>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" name="Receivedby" required="required">
                                                <option> </option>
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control select" name="Honorific" required="required">
                                                <option> </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name='En_Fname'  required="required" pattern="[a-zA-Z]+"/>
                                    ...
                                    <div class="form-group">        
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name='En_Lname'  required="required" pattern="[a-zA-Z]+"/>
                                            </div>            
                                            <span class="help-block">Start with Capital Letter , don't accept spaces , symbols , numbers and arabic letters</span>
                                        </div>
                                    </div>
                                       ...
                                       <div class="form-group">                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-unlock-alt"></span></span>
                                                <input type="text" class="form-control" name='Ar_Fname'  required="required" pattern="^[\u0621-\u064A\u0660-\u0669 ]+$"/>
                                            </div>            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" class="form-control" name='Ar_Lname'  required="required"  pattern="^[\u0621-\u064A\u0660-\u0669 ]+$" >
<!-- pattern="[ي-ؤ-ئ-ا-ى]+"  -->                                                
                                            </div>                                            
                                            <span class="help-block">Don't accept spaces , symbols ,numbers and english letters</span>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select name="KnownFrom" class="form-control select" required="required">
                                                     <option  > </option>
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select name="CallType" class="form-control select" required="required">
                                                     <option  > </option>
