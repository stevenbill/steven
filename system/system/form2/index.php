...
if ($_SESSION['logindata']) {
	echo 'Welcome ' . $_SESSION['logindata'];
}else{
...
echo "<h1> error</h1>";
    ...
    if($seg=='usera' or $seg=='userb'or $seg=='userc' or $seg=='userd'){
die("<h1> you dont have a permission");
}
...
if ($_POST['send1']) {
  $move=move_uploaded_file($path,$dir.$name);
  echo var_dump($name);
 echo "<script type='text/javascript'>alert('تم ارسال الصور بنجاح');</script>";
...
if (@$_POST['send']) {
 ...
 echo "<script type='text/javascript'>alert('تم ارسال بينات الوحده بنجاح متنساش صور الوحده يا ريس');</script>";
...
function showPosition(position) {
    ...
    /*window.location.href = "index.php?w1=" + position.coords.latitude + "&w2=" +  position.coords.longitude;*/
   /* var var1 = position.coords.latitude ;
    var var2 =  position.coords.longitude;*/

 var var1= position.coords.latitude ;
  var var2= position.coords.longitude;
    document.getElementById("fsite").value=var1;
        document.getElementById("lsite").value=var2;
...
<div>
		      <label for="name">
		      	...
		      	<input type="text" id="fsite"      name="fsite"id="email" placeholder="  location"     tabindex="1" autofocus="autofocus"/ onload="displayDate()"  readonly >
		      </label> 
			</div>
...
<div>
		      <label for="name">
		      	<span class="required"> ثانى رقم من موقعك: *</span> 
		      		<input type="text" id="lsite"      name="lsite"id="email" placeholder="location2"     tabindex="1" autofocus="autofocus" /  onload="displayDate()"  readonly>
		      </label> 
			</div>
			...
			<div>
		      <label for="name">
		      	...
		      	<!--<input type="text" id="name"      name="number" placeholder="رقم الموبيل"     tabindex="1" autofocus="autofocus" required />-->

                            <input type='tel' id="name" name="number" placeholder="رقم الموبيل"     pattern="^[0-9]{11}$" title='Phone Number (Format: +012(11رقم))' tabindex="1" autofocus="autofocus" required>
			...
			<div>		          
		      <label for="subject">
		      <span> منطقه: </span>
			      <select id="subject"  name="address" placeholder=" المنطقه "  tabindex="4" required > 
...
<option value="بولكلى">  بولكلى</option>
	...
	<div>
		      <label for="name">
		      	...
		      	<input type="text" id="name"    name="address_houes" placeholder=" عنوان "  tabindex="1" autofocus="autofocus" required  />
		      </label> 
			</div>
			...
			<div>		          
		      ...
		      <span>نوع الوحده: </span>
			      <select id="subject" name="kind_houes" tabindex="4" required > 
					  <option value=""></option>  
			...
			<div>		          
		      ...
		      <span>نوع العمليه: </span>
			      <select id="subject" name=" kind_of_pro" tabindex="4" required > 
					  <option value=""></option>  
			...
			<div>	
		      ...
		      <span> عدد ادوار العقار: </span>
			      <select id="subject"   name="adwar"   name="subject" tabindex="4" required >   
					 <option value=""></option> 
  <option value=" الارضى"> لارضى</option> 
  <option value=" 1"> 1</option>
			...
			<div>	-->
                  ...
                  <label for="subject">
		      <span> الرخصه : </span>
			      <select id="subject"   name="num_land" placeholder=" الرخصه "   tabindex="4" required >
					 <option value=""></option>  
  <option value=" 1"> 1</option>
                          <option value="2"> 2</option>
                           <option value="3"> 3</option>
			...
			<div>	
		      ...
		      <label for="subject">
		      <span> الواجهه: </span>
			      <select id="subject" name="wagha" placeholder="واجه" name="subject" tabindex="4" required >   
					 <option value=""></option>  
            ...
            <label for="subject">
		      ...
		      <label for="name">
		      	...
		      	<input type="text" id="name"     name="msaha" placeholder="مساحه"     tabindex="1" autofocus="autofocus"  required />
		      </label> 
			</div>
                  ...
                  <label for="subject">
		      <span> دور : </span>
			      <select id="subject"    name="dor" tabindex="4" required  >
					 <option value=""></option>  
 <option value=" لارضى"> لارضى</option>
  ...
  <option value=" 1"> 1</option>
			...
			<div>	
                  ...
                  <label for="subject">
		      <span> عدد الغرف: </span>
			      <select id="subject"   name="room" placeholder=" عدد الحجرات "  name="subject" tabindex="4"   required>   
					 <option value=""></option>  
  <option value=" 1"> 1</option>
                          <option value="2"> 2</option>
                           <option value="3"> 3</option>
			...
			<div>	
		      ...
		      <span> عدد الحمامات: </span>
			      <select id="subject"   name="bath" placeholder=" عدد الحمامات "  name="subject" tabindex="4"   required>   
					 <option value=""></option>  
  <option value=" 1"> 1</option>
                          <option value="2"> 2</option>
                           <option value="3"> 3</option>
			...
			<div>	
		      ...
		      <span> عدد الريسبشن: </span>
			      <select id="subject"    name="resh" placeholder="الريسبيشن "  name="subject" tabindex="4"   required>   
					 <option value=""></option>  
  <option value=" 1"> 1</option>
                          <option value="2"> 2</option>
                           <option value="3"> 3</option>
			...
			<div>	
		      ...
		      <span> مطلات الغرف  على شارع: </span>
			      <select id="subject"    name="matalat" placeholder="مطلات "   name="subject" tabindex="4" required  >   
					 <option value=""></option>  
  <option value=" 1"> 1</option>
                          <option value="2"> 2</option>
                           <option value="3"> 3</option>
			...
			<div>	
		      ...
		      <span>    غرف على الشارع : </span>
			      <select id="subject"    name="onstreet" placeholder="مطلات "   name="subject" tabindex="4"   required>   
					 <option value=""></option>  
  <option value=" نعم"> نعم</option>
			...
			<div>	
                  ...
                  <label for="subject">
		      <span> عدد ادوار العقار : </span>
			      <select id="subject"    name="num_dor" tabindex="4" required  >   
					 <option value=""></option>  
  <option value=" 1"> 1</option>
                          <option value="2"> 2</option>
                           <option value="3"> 3</option>
			...
			<div>	
		      ...
		      <span> باكيه الجراج: </span>
			      <select id="subject"    name="garash"  placeholder="باكيه الجراج "  name="subject" tabindex="4" required  >   
					 <option value=""></option>  
			...
			<div>	
                  ...
                  <label for="subject">
		      <span>  مبانى: </span>
			      <select id="subject"     name="mabany" placeholder="مبانى "   name="subject" tabindex="4"   required >   
					  <?php
  ...
  ?>
			...
			<div>	
		      ...
		      <span>  نوع التشطيب : </span>
			      <select id="subject"     name="tashteb" placeholder="نوع التشطيب "name="subject" tabindex="4" required  >   
					 <option value=""></option>
<option value="لايوجد">  لايوجد</option>
   ...
   <option value="نصف التشطيب"> نصف تشطيب</option>
		      ...
		      <span> اسانسير : </span><!--متكريتلهمش حاجه فى داتا بيز -->
			      <select id="subject"   name="asanser"   placeholder=" اسانسير "name="subject" tabindex="4"   required>   
					 <option value=""></option> 
<option value="لايوجد">  لايوجد</option> 
...
<!-- <div>
		      <label for="name">
		      	...
		      	<input type="text" id="name" name="adad" placeholder="عدادات "     tabindex="1" autofocus="autofocus"  required  />
		      </label> 
			</div>-->

 <label for="subject">
		      <span> عداد الكهرباء : </span><!--متكريتلهمش حاجه فى داتا بيز -->
			      <select id="subject"   name="kahrba"   placeholder=" اسانسير "name="subject" tabindex="4"   required>   
					 <option value=""></option>  
 ...
 <label for="subject">
		      <span> عداد مياه : </span><!--متكريتلهمش حاجه فى داتا بيز -->
			      <select id="subject"   name="water"   placeholder=" اسانسير "name="subject" tabindex="4" required  >   
					 <option value=""></option>
 ...
 <label for="subject">
		      <span> عداد الغاز : </span><!--متكريتلهمش حاجه فى داتا بيز -->
			      <select id="subject"   name="gas"   placeholder=" اسانسير "name="subject" tabindex="4" required  >   
					 <option value=""></option>  
		      ...
		      <span> عدد شقق فى دور: </span>
			      <select id="subject"  name="num_of_houes" tabindex="4" required  >    
					 <option value=""></option>
  ...
  <option value=" 1"> 1</option>
			...
			<div>	
		      ...
		      <label for="name">
		      	...
		      	<input type="text" id="name" name="price" placeholder=" سعر الوحده "   tabindex="1" autofocus="autofocus"  required  />
		      </label> 
			</div>
...
<!-- نظام الدفع كاش او اقسط انا نسيه هنا  -->
		      ...
		      <span>   مدخل العماره: </span>
			      <select id="subject"   name="enter"   name="subject" tabindex="4" required  > 
					 <option value=""></option>  
...
<div>
		      <label for="name">
		      	...
		      	<input type="text" id="name"  name="w_street"    id="email" placeholder=" عرض الشارع   "    tabindex="1" autofocus="autofocus"  required  />
		      </label> 
			</div>
                  ...
                  <label for="subject">
		      <span>    العموله: </span>
			      <select id="subject"  name="3mola"   name="subject" tabindex="4" required  > 
					 <option value=""></option>  
