...
$Appartment = $_POST['Appartment'];
		 $Time = date('G:i:s');
		 $VisitSerial  = substr(uniqid(rand(), true), 7, 7);
...
if($_POST['send']){
	...
	$sql = "INSERT INTO  visit (PhoneNumber,ReqSerial,Apartment,Type,VisitDate,VisitTime,Representative,Note,Date,Time,RegBy,VisitSerial) VALUES
				('$PhoneNumber','$ReqSerial','$Apartment','$Type','$Date','$VisitTime','$Representative','$Note','$date','$Time','$seg','$VisitSerial') ";
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" action='Visit.php'  enctype="multipart/form-data" >
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Visit/</strong> Form</h3>
...
<!--
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control"name="PhoneNumber" id="country" onmousemove="change_country();"   required />
  ...
  <?php
                                     ...
                                     ?>
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control select" data-live-search="true" name="PhoneNumber" id="country" onchange="change_country();"  required >
                                                   <option></option>
...
<?php } ?>
                                     ...
                                     <select class="form-control selectpicker" name="ReqSerial" id="state" class="dropdown"  required  >
  ...
  <?php
                                     ...
                                     ?>
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control select" data-live-search="true" name='Apartment' required >
                                                   <option></option>
                                             <?php while($row = $query->fetch_assoc()) { ?>
  <option  value="<?php echo $row['Apt_Code']; ?>"><?php echo $row['Apt_Code']; ?> </option>
<?php } ?>
                                            </select>
                                        </div>
                                    </div></p>
                                     ...
                                     <br>
                                                                           ...
                                                                           <div class="form-group">
                                                                             ...
                                                                             <div class="col-md-6 col-xs-12">
                                                                                <select class="form-control " name="Type" id='Type' >
																								<option> </option>
																								<option value="Request_V">Request_V</option>
																								<option value="Follow_V">Follow_V</option>
                                                                         ...
                                                                         <div class="form-group">
                                                                           <label class="col-md-3 col-xs-12 control-label">Visit Date</label>
                                                                             <div class="col-md-6 col-xs-12">
                                                                      ...
                                                                      <div class="form-group">
                                                                          <label class="col-md-3 col-xs-12 control-label">Visit Time</label>
                                                                             <div class="col-md-6 col-xs-12">
                                                                                 <select class="form-control " name="VisitTime" id='VisitTime' >
																								<option> </option>
                                                                      ...
                                                                      <div class="form-group">
                                                                          <label class="col-md-3 col-xs-12 control-label">Representative</label>
                                                                             <div class="col-md-6 col-xs-12">
                                                                                 <select class="form-control " name="Representative" id='Representative' >
																								<option> </option>
																								<option value="Ahmed Hani">Ahmed Hani</option>
																								<option value="Mohsen Mansour">Mohsen Mansour</option>
