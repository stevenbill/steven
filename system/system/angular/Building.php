...
mysql_query($sql2);
   ...
   $y=date("y") ;
    ...
    $up="UPDATE `Building1` SET `Bui_Serial`='B$last_insert_id-$m($y)' WHERE id='$last_insert_id' ";
mysql_query($up);
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Building/</strong> Form</h3>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control" name="DealType" required >
                                                        ...
                                                        <option> </option>
                                                <option value="Individual Units">Individual Units</option>
                                                <option value="Full Units">Full Units</option>
                                   ...
                                   <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                           ...
                                           <input type="text" class="form-control" name="Buildingno" required pattern="[0-9]{1,5}$">
                                           
                                           
                                           
                                            <span class="help-block">Accept numbers only no letters no symbols
</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                           ...
                                           <input type="text" class="form-control" name="Address" ="required" pattern="[0-9A-Za-z/\s-]*" required>
                                           <!-- pattern="[0-9A-Za-z/\s-]*"  -->
                                           
                                           
                                            <span class="help-block">Don't accept symbols
</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control" name="ResidentialDeposit" required >
                                                <option> </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control " name=" LicenseFloor" required >
                                                <option> </option>
                                                <option value="1"> 1</option>
                                                <option value="2"> 2</option>
                                                <option value="3"> 3</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control" name="Elevatorno"  required>
                                                <option> </option>
                                                  <option value="1"> 1</option>
                                                <option value="2"> 2</option>
                                                <option value="3"> 3</option>
                               ...
                               <!------------------code here--------------------------->
                                   ...
                                   <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control " name="SourceBY"  required>
                                                <option> </option>
