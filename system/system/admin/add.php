											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<label class="checkbox-inline">
														<input type="checkbox" name="inserthome" value="disabled"> 
														 ادخال بيانات العقار</label>

													<label class="checkbox-inline">
														<input type="checkbox"name="insertcatch" value="disabled" >
														 تسجيل التصوير</label>

													<label class="checkbox-inline" >
														<input type="checkbox" name="insertcall" value="disabled">
													 ...
													 <label class="checkbox-inline" >
														<input type="checkbox" name="ziara3" value="disabled">
...
<!--
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<label class="checkbox-inline">
														<input type="checkbox" name="showcall" value="disabled">
														 اظهار بيانات لاتصال </label>

													<label class="checkbox-inline">
														<input type="checkbox" name="showcatch" value="disabled"> 	
														 اظهار بيانات التصوير </label>

														 <label class="checkbox-inline">
														<input type="checkbox" name="showhome" value="disabled"> 	
														 اظهار بيانات العقار </label>


														 <label class="checkbox-inline">
														<input type="checkbox" name="showhomesaled" value="disabled"> 	
														 اظهار بيانات العقارات المباعه </label>
                                                                                                                                              
                                        <label class="checkbox-inline" >
														<input type="checkbox" name="ad" value="disabled">
													  اظهار بيانات عقد التسويق  </label>
                                                                                    


<label class="checkbox-inline">
														<input type="checkbox" name="showhomenotsaled" value="disabled"> 	
														 اظهار بيانات العقارات غير مباعه </label>


														<input type="checkbox">
															البحث فى البيانات </label>
															<input type="checkbox" name="search" value="disabled">


															<label class="checkbox-inline">
														<input type="checkbox"  name="shared" value="disabled">
