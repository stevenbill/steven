...
$x = $_POST['user'];
if ($x=="09:00" or $x=="10:00" or $x=="11:00" or $x=="12:00" or $x=="01:00" or $x=="02:00" or $x=="03:00" or $x=="04:00" or $x=="05:00" ){
...
<input onclick="window.open('http://www.google.com','_blank','resizable=yes')" type="submit" id="modal" data-modal="modal" name="send" value="click me" >
    </form>
...
if($_POST['send1']){
$result2=mysql_query("SELECT count(EMail1) as total from company");
...
$sqlm="SELECT * FROM `company` WHERE EMail1 NOT LIKE ',%'" ;/*test*/
...
$id2=[];
$result=[];
$time = array('09:00','10:00','11:00','12:00','01:00','02:00','03:00','04:00','05:00');
...
$message .= "Content-Type: text/html; charset=\"iso-8859-1\"\r\n"
  ...
  ." <center > <img src='http://estasmer.com/mailtest/up/tracker/$boos' alt='image not found' style=' max-width: 100%; max-hight: 100%;' title='Logo' style='display:block'  /> </center>\r\n" 
...
$sql="insert into  email1 (CompanyName,Message,seg,email,Date,send,attach5,boos,times) values('$CompanyName','$message606','$seg','$value','$date','$send','$attach5','$boos','$times')";
...
$fileba=explode(";",$ba);
      ...
      foreach ($fileba as $ahmed) {
          if (!empty($ahmed)){
   $sqlbad="insert into  email2 (email) values('$ahmed')";
