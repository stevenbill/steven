                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                   ...
                                   <div class="panel-body">                                                              
                                     ...
                                     <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Req_Serial</label> 
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control" name="Req_Serial" required>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control" name="VisitDate" required >
                                                <option> </option>
                                                <option value=""></option>
                                                <option value=""></option>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control" name="VisitTime" required>
                                                <option> </option>
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select class="form-control" name="Representative" required>
                                                <option> </option>
                                                <option value="Before 2000"> Ahmed Hani</option>
