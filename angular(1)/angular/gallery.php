                                ...
                                <li><a href="request-show.php"><span class="fa fa-download"></span> Request</a></li> 
                                  ...
                                  <li><a href=" customer-follow-show.php"><span class="fa fa-download"></span>  customer-follow Show</a></li>
                                   ...
                                   <li><a href=" requestfollowshow.php"><span class="fa fa-download"></span>  Request Follow Show</a></li> 
                                      <li><a href=" Apartment-show.php"><span class="fa fa-download"></span>   Apartment-show</a></li> 
...
mysql_select_db($db) or die("db selction error ");
	...
	mysql_error();
                                            ...
                                            $sql="SELECT image FROM image where ID='$ID' ORDER BY ID DESC " ;
$q=mysql_query($sql) ;
  ...
  while($row=mysql_fetch_array($q)){
    ...
    $x=$row['image'];
                        ...
                        echo  " <a class='gallery-item' href='imgesup/$x' title='Nature Image 1' data-gallery>";
                              echo"  <div class='image'>";                              
                                    echo "<img src='imgesup/$x' alt='Nature Image 1'/>  ";                                      
                                    echo"<ul class='gallery-item-controls'>";
                                        echo "<li><label class='check'><input type='checkbox' class='icheckbox'/></label></li>";
                            ...
                            <?php
                              echo "<ul class='pagination pagination-sm pull-right push-down-20 push-up-20'>";
